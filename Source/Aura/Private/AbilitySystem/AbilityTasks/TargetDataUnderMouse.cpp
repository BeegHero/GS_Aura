...
void UTargetDataUnderMouse::Activate()
{
	...
	} else
	{
		...
		AbilitySystemComponent.Get()->AbilityTargetDataSetDelegate(Handle, ActivationPredictionKey)
			.AddUObject(this, &ThisClass::OnTargetDataReplicatedCallback);
		const bool bCalledDelegate = AbilitySystemComponent.Get()->CallReplicatedTargetDataDelegatesIfSet(Handle, ActivationPredictionKey);
		if (!bCalledDelegate)
		{
